...
def bookmarklet(request):
    ...
    #srcUrl below should eventually be imgUrl generated by javascript based on image selection.
    resp = render_to_string('core/bookmarklet.js',context_instance=RequestContext(request, {"imgUrl": srcUrl}))
